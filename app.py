...
st.set_page_config(
    layout="wide", page_title='Covid19 India Daily Analysis', page_icon='icon.png')
...
st.markdown("<h1 style='text-align: center; letter-spacing:12px;font-size: 65px; color: #999;'>INDIA COVID-19 ANALYSIS</h1>", unsafe_allow_html=True)
...
with c2:
    st.markdown(
        f"<h5 style='text-align: center; letter-spacing:10px;font-size: 28px; color: #888;'>- OVERALL -</h5>", unsafe_allow_html=True)
    st.text('')
    st.text('')
    st.markdown(
...
with c22:
    st.markdown(
        f"<h5 style='text-align: center; letter-spacing:10px;font-size: 28px; color: #888;'>- {date_.split(':')[1].strip().upper()} -</h5>", unsafe_allow_html=True)
    st.text('')
    st.text('')
    st.markdown(
...
with col1:
    st.text('')
    st.markdown(
        f"<h5 style='text-align: center; letter-spacing:10px;font-size: 18px; color: #888;'>TOTAL CASES</h5>", unsafe_allow_html=True)
    st.text('')
...
with col2:
    st.text('')
    st.markdown(
        f"<h5 style='text-align: center; letter-spacing:10px;font-size: 18px; color: #888;'>CASES ON {date_.split(':')[1].strip().upper()}</h5>", unsafe_allow_html=True)
    st.text('')
...
c10, c11, c12, c13 = st.beta_columns([1, 2, 2, 1])
